...
class LogIn(unittest.TestCase):
    def test_wrong_code(self):
        response = client.get(f"{url}/api/discord/auth?code=wrong_code")
        self.assertEqual(response.status_code, 401)

    def test_code(self):
        response = client.get(f"{url}/api/discord/auth?code={input('code - >')}")
...
class OpenTicket(unittest.TestCase):
    ...
    def test_open(self):
        response = client.get(
            f"{url}/api/tickets/open?text=Test ticket",
...
class ChangeState(unittest.TestCase):
    token = '1sgWbOfUPXzDUDthUYG8SP5TFFR0lM'
    guid_ticket = '892c52fd-7251-42b6-ae44-8b6afd853375'

    def test_change_state(self):
        response = client.get(
            f"{url}/api/tickets/change_status?guid_ticket={self.guid_ticket}&new_status=processing",
            headers={"Authorization": f"Bearer {self.token}"}
        )
        print("response = ", response.json())
        self.assertEqual(response.status_code, 200)
    ...
    def test_change_state_without_new_status(self):
        response = client.get(
            f"{url}/api/tickets/change_status?guid_ticket={self.guid_ticket}",
            headers={"Authorization": f"Bearer {self.token}"}
        )
        print("response = ", response.json())
        self.assertEqual(response.status_code, 422)
    ...
    def test_change_state_without_guid_ticket(self):
        response = client.get(
            f"{url}/api/tickets/change_status?new_status=processing",
            headers={"Authorization": f"Bearer {self.token}"}
        )
        print("response = ", response.json())
        self.assertEqual(response.status_code, 422)
...
class GetTickets(unittest.TestCase):
    ...
    def test_get_tickets_not_exists(self):
        response = client.get(
            f"{url}/api/tickets/get?guid_ticket={self.not_guid_ticket}",
            headers={"Authorization": f"Bearer {self.token}"}
        )
        print("response = ", response.json())
        self.assertEqual(response.status_code, 200)
    ...
    def test_get_tickets_exists(self):
        response = client.get(
            f"{url}/api/tickets/get?guid_ticket={self.guid_ticket}",
            headers={"Authorization": f"Bearer {self.token}"}
        )
        print("response = ", response.json())
        self.assertEqual(response.status_code, 200)
    ...
    def test_get_tickets_author(self):
        response = client.get(
            f"{url}/api/tickets/get?author={self.author}",
            headers={"Authorization": f"Bearer {self.token}"}
        )
        print("response = ", response.json())
        self.assertEqual(response.status_code, 200)
    ...
    def test_get_tickets_wrong_author(self):
        response = client.get(
            f"{url}/api/tickets/get?author=wrong_author",
            headers={"Authorization": f"Bearer {self.token}"}
        )
        print("response = ", response.json())
        self.assertEqual(response.status_code, 200)
    ...
    def test_get_tickets_status(self):
        response = client.get(
            f"{url}/api/tickets/get?status=open",
            headers={"Authorization": f"Bearer {self.token}"}
        )
        print("response = ", response.json())
        self.assertEqual(response.status_code, 200)
    ...
    def test_get_tickets_wrong_status(self):
        response = client.get(
            f"{url}/api/tickets/get?status=wrong_status",
            headers={"Authorization": f"Bearer {self.token}"}
        )
        print("response = ", response.json())
        self.assertEqual(response.status_code, 400)
